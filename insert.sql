INSERT INTO `STUDENT` (`FirstName`, `LastName`, `Major`, `StudentID`)
VALUES
('Damola', 'Quadri', 'Computer Science', 1234),
('John', 'Dairy', 'Management Science', 5678),
('Emily', 'Berkley', 'Aviato', 3456),
('Hosea', 'Quinacy', 'Marine Biology', 4590),
('George', 'Floyd', 'Computer Engineering', 5337),
('Jack', 'Downie', 'English', 5555);
